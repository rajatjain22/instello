export default function NewSideBar() {
  return (
    <div className='fixed top-0 left-0 z-40 max-md:top-auto max-md:bottom-0'>
      <div className='flex sside md:flex-col justify-between md:h-screen md:p-2 p-1 transition-all duration-500 bg-white shadow dark:bg-dark2 2xl:w-72 xl:w-60 max-xl:w-[73px] max-md:w-screen max-md:border-t max-md:dark:border-slate-700'>
        {/* <!-- logo --> */}
              ...
              <div className='px-2 -mt-2 text-sm font-normal'>
                ...
                >
                  ...
                  <div className='flex-1 '>
                    <p>
                      {" "}
                      <b className='font-bold mr-1'> John Michael</b> mentioned you
                      in a story. Check it out and reply. 📣{" "}
                    </p>
                    <div className='text-xs text-gray-500 mt-1.5 dark:text-white/80'>
                      {" "}
