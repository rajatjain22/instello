        ...
        <div class="px-2 -mt-2 text-sm font-normal">
          ...
          >
            ...
            <div class="flex-1 ">
              <p>
                {" "}
                <b class="font-bold mr-1">Jesse Steeve</b> mentioned you in a
          ...
          >
            ...
            <div class="flex-1 ">
              <p>
                {" "}
                <b class="font-bold mr-1"> Alexa stella</b> commented on your
          ...
          >
            ...
            <div class="flex-1 ">
              <p>
                {" "}
                <b class="font-bold mr-1"> John Michael</b> mentioned you in a
                story. Check it out and reply. 📣{" "}
              </p>
              <div class="text-xs text-gray-500 mt-1.5 dark:text-white/80">
                {" "}
          ...
          >
            ...
            <div class="flex-1 ">
              <p>
                {" "}
                <b class="font-bold mr-1"> Jesse Steeve</b> who you might know,
                is on Instello.{" "}
              </p>
              <div class="text-xs text-gray-500 mt-1.5 dark:text-white/80">
                {" "}
          ...
          >
            ...
            <div class="flex-1 ">
              <p>
                {" "}
                <b class="font-bold mr-1"> Martin Gray</b> liked your photo of
                the Eiffel Tower. 😍{" "}
              </p>
              <div class="text-xs text-gray-500 mt-1.5 dark:text-white/80">
                {" "}
